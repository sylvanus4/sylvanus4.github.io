...
const UI = {
  ko: {
    ...
    "meta.demosTitle": "돌아가는 데모 80개 · 한효정",
    ...
    "tech.lede1":
      "직접 만들어 굴리고 있는 저장소 <b id=\"techtotal\">173</b>개입니다. 새 과제를 받으면 백지에서 시작하지 않고 이 목록에서 맞는 조각을 먼저 찾습니다. 그래서 첫 결과가 빨리 나옵니다.",
    "tech.lede2":
    ...
    "demos.lede":
      "브라우저에서 그 자리에서 계산하는 데모 <b id=\"demototal\">80</b>개입니다. 영상도 슬라이드도 아니고 값을 바꾸면 결과가 다시 나옵니다. 제가 다루는 문제가 실제로 어떤 모양인지 보시는 게 가장 빠릅니다.",
    "demos.note":
    ...
    "search.aria": "사이트 검색",
    "search.ph": "무엇을 찾으시나요",
    "search.hint": "제목·설명·태그를 함께 찾습니다. 초성도 됩니다 — ㅇㅈㅎ → 양자화. 여는 단축키는 / 또는 ⌘K.",
    "search.none": "결과가 없습니다",
    "search.countSuffix": "건",
    "search.close": "검색 닫기",
    "search.failed": "검색 인덱스를 불러오지 못했습니다",
    "demos.shotAlt": "화면 캡처",
  ...
  en: {
    ...
    "meta.demosTitle": "80 Live Demos · Hyojung Han",
    ...
    "tech.lede1":
      "<b id=\"techtotal\">173</b> repositories I built and still maintain. When a new problem arrives I do not start from a blank page. I look here first for a piece that fits, which is why the first result comes quickly.",
    "tech.lede2":
    ...
    "demos.lede":
      "<b id=\"demototal\">80</b> demos that compute in your browser on the spot. Not a video and not a slide: change a value and the result is recomputed. The fastest way to see the shape of the problems I work on.",
    "demos.note":
    ...
    "search.hint": "Searches titles, descriptions and tags. Korean initials work too. Open with / or \u2318K.",
    "search.none": "Nothing found",
    "search.countSuffix": " results",
    "search.close": "Close search",
    "search.failed": "Could not load the search index",
