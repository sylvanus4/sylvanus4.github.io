...
const UI = {
  ko: {
    ...
    "tech.lede1":
      "직접 만들어 굴리고 있는 저장소 <b id=\"techtotal\">161</b>개입니다. 새 과제를 받으면 백지에서 시작하지 않고 이 목록에서 맞는 조각을 먼저 찾습니다. 그래서 첫 결과가 빨리 나옵니다.",
    "tech.lede2":
  ...
  en: {
    ...
    "tech.lede1":
      "<b id=\"techtotal\">161</b> repositories I built and still maintain. When a new problem arrives I do not start from a blank page. I look here first for a piece that fits, which is why the first result comes quickly.",
    "tech.lede2":
