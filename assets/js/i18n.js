...
const UI = {
  ko: {
    ...
    "meta.demosTitle": "돌아가는 데모 55개 · 한효정",
    ...
    "tech.lede1":
      "직접 만들어 굴리고 있는 저장소 <b id=\"techtotal\">170</b>개입니다. 새 과제를 받으면 백지에서 시작하지 않고 이 목록에서 맞는 조각을 먼저 찾습니다. 그래서 첫 결과가 빨리 나옵니다.",
    "tech.lede2":
    ...
    "demos.lede":
      "브라우저에서 그 자리에서 계산하는 데모 <b id=\"demototal\">55</b>개입니다. 영상도 슬라이드도 아니고 값을 바꾸면 결과가 다시 나옵니다. 제가 다루는 문제가 실제로 어떤 모양인지 보시는 게 가장 빠릅니다.",
    "demos.note":
  ...
  en: {
    ...
    "meta.demosTitle": "55 Live Demos · Hyojung Han",
    ...
    "tech.lede1":
      "<b id=\"techtotal\">170</b> repositories I built and still maintain. When a new problem arrives I do not start from a blank page. I look here first for a piece that fits, which is why the first result comes quickly.",
    "tech.lede2":
    ...
    "demos.lede":
      "<b id=\"demototal\">55</b> demos that compute in your browser on the spot. Not a video and not a slide: change a value and the result is recomputed. The fastest way to see the shape of the problems I work on.",
    "demos.note":
